        ...
        <div class="col-md-8">
            ...
            <form action="/submit_subject" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="subjectName" name="subjectName" placeholder="أدخل اسم المادة" required>
                </div>

                <div class="form-group">
                    <label for="subjectCode">رمز المادة</label>
                    <input type="text" class="form-control" id="subjectCode" name="subjectCode" placeholder="أدخل رمز المادة" required>
                </div>
